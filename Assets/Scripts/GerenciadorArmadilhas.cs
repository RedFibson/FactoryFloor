...
public enum TipoObstaculo { Serra, Laser, Spike, Turret }
...
public class GerenciadorArmadilhas : MonoBehaviour
{
    ...
    [Header("⚡ Configurações do Laser/Spike")]
    ...
    private void Start()
    {
        ...
        colisorLaser = GetComponent<Collider2D>();
    ...
    private void DesligarLaser()
    {
        ...
        if (anim != null) anim.SetInteger("Estado", 2);
    }
